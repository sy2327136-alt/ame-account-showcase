(function () {
  ...
  function card(product) {
    ...
    return `<article class="product-card home-product-card">
      ...
      <a href="./${product.productType === "account" ? "accounts" : "recharge"}.html?game=${encodeURIComponent(product.gameName)}" class="card-image"><img src="${GM.escape(product.coverImage)}" alt="${GM.escape(product.title)}" loading="lazy">${product.badge ? `<span class="card-badge">${GM.escape(product.badge)}</span>` : ""}</a>
